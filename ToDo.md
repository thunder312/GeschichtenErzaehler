...
- [ ] Es soll jeder Epoche eine Farbe zugeordnet werden, um die Übersicht zu verbessern. Die Projektliste soll die entsprechende Farbe im Design wiedergeben. Vielleicht eher als fabiges Quadrat irgendwo in der Zeile und nicht in der Schriftfarbe, da das die Lesbarkeit gefährden könnte. Die bestehenden Epochen auf Prod darfst du schon mal vorbelegen mit einer Farbe. Man kann diese aber jederzeit ändern in Epochen bearbeiten. Die Projekt-Liste aktualisiert dann sofort.
- [ ] entferne den Mouseover-Effekt im Geschichten Erzähler Schriftzug ganz oben. Der hat ja keinen echten Effekt.
- [ ] Es fehlt noch die Möglichkeit im Architekten einen Schritt zurückgehen zu können, falls man versehentlich Enter drückt oder einem nachher noch wa einfällt. 
# Bugs
