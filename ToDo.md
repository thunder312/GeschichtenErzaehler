...
- [ ] Gerüst-Editor mit Struktur-Zwang (Phase 2 - Kapitelplan-Block-Editor): Manuelles Bearbeiten von geruest.md (z.B. nach "Neu schreiben") kann das Gerüst unbemerkt strukturell ungültig machen (Vorfall: a-Blut-und-Ahornlaub-Die-Ehre-des-Verbotenen, 2026-08-20 - alle "Zielwortzahl"-Zeilen im Kapitelplan versehentlich entfernt). Phase 1 (serverseitige Validierung beim Speichern, `kapitelplan_pruefen()` in backend/app/core/geruest.py, meldet fehlende Zielwortzahl/doppelte Kapitelnummer mit klarer Fehlermeldung statt klaglos zu speichern) ist erledigt (2026-08-20). Offen: Phase 2, ein strukturierter Block-Editor NUR für den Kapitelplan-Abschnitt (eigene Karte pro Kapitel: Ort, Figuren, Ereignis, Zielwortzahl als Pflicht-Zahlenfeld etc. statt Freitext-Bullet-Liste, "+ Kapitel"/"Kapitel löschen"-Buttons), bei "Neu schreiben" vorbefüllt aus dem Ausgangsprojekt. Rest des Gerüsts (Rahmen, Figuren, Ausgangslage, Regeln) bleibt bewusst Freitext, da diese Abschnitte je Epoche unterschiedliche, teils frei vom User erfundene Feldnamen haben (z.B. "Kaigyū" statt "Stand" bei einer selbst angelegten Epoche) - ein festes Schema dafür wäre ein eigenes, größeres Vorhaben (Epoche-Wizard umbauen). Die enum-artigen Rahmen-Felder (Jugendschutz-Stufe, Autor-Modell, Automatische Fortsetzung) könnten dabei zusätzlich als echte Dropdowns rausgezogen werden, da sie heute schon per Regex geparst werden.
# Bugs
