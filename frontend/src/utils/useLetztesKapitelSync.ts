...
/** Haelt die Kapitelnummer eines Review-Tabs (Lektorieren, Pruefen &
 * Anwenden, Rechtschreibung, Stand & Export) synchron mit dem zuletzt
 * geschriebenen Kapitel - der haeufigste Workflow ist "Kapitel schreiben,
 * dann direkt dieses Kapitel pruefen/lektorieren". Reagiert auch, wenn der
